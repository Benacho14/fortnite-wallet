  ...
  return (
    <div className="px-4 space-y-6">
      ...
      {activeTab === 'products' && (
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {products.map((product) => (
            <div key={product.id} className="bg-gray-800 rounded-lg p-6 space-y-3">
              ...
              <button
                ...
                className="w-full py-2 px-4 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-600 rounded-md font-medium"
              >
          ...
          {products.length === 0 && (
            <p className="col-span-full text-center text-gray-400 py-8">No products available</p>
          )}
        </div>
      )}
      ...
      {activeTab === 'stores' && (
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {stores.map((store) => (
            <div key={store.id} className="bg-gray-800 rounded-lg p-6 space-y-3">
              <h3 className="text-xl font-bold">{store.name}</h3>
              {store.description && <p className="text-gray-400">{store.description}</p>}
          ...
          {stores.length === 0 && (
            <p className="col-span-full text-center text-gray-400 py-8">No stores yet</p>
          )}
        </div>
      )}
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-gray-800 rounded-lg p-6">
            ...
            <form onSubmit={handleCreateStore} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full py-2 px-4 bg-green-600 hover:bg-green-700 rounded-md font-medium"
              >
                Create Store
              </button>
            </form>
